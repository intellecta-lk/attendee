    ...
    "properties": {
        "deepgram": {
            ...
            "properties": {
                ...
                "replace": {"type": "array", "items": {"type": "string"}, "description": "Find and replace terms or phrases in the transcript. Each string should be in the format 'term_to_find:replacement_term' (e.g., 'kpis:Key Performance Indicators'). See here for details: https://developers.deepgram.com/docs/find-and-replace"},
            },
            "additionalProperties": False,
        },
        "gladia": {
